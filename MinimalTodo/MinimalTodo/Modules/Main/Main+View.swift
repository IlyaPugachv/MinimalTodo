...
//            view.isHidden = true
//            view.backgroundColor = .white
//            view.alpha = 0 // Set transparency initially
//            return view
//        }()
//        
...
//                fullScreenView.bottomAnchor.constraint(equalTo: view.bottomAnchor),
//                
//                searchTextField.topAnchor.constraint(equalTo: fullScreenView.topAnchor, constant: 70),
//                searchTextField.leadingAnchor.constraint(equalTo: fullScreenView.leadingAnchor, constant: 20),
//                searchTextField.trailingAnchor.constraint(equalTo: fullScreenView.trailingAnchor, constant: -20),
//                searchTextField.heightAnchor.constraint(equalToConstant: 40),
//                
//                cancelButton.topAnchor.constraint(equalTo: fullScreenView.topAnchor, constant: 70),
//                cancelButton.trailingAnchor.constraint(equalTo: fullScreenView.trailingAnchor, constant: -20),
//                cancelButton.widthAnchor.constraint(equalToConstant: 80),
//                cancelButton.heightAnchor.constraint(equalToConstant: 40)
//            ])
//        }
...
//        @objc private func searchImageViewTapped() {
//            fullScreenView.isHidden = false
//            fullScreenView.alpha = 1 // Make it fully visible
//            
//            view.subviews.compactMap { $0 as? TodoListView }.forEach { $0.isHidden = true }
//        }
//        
//        @objc private func cancelButtonTapped() {
//            fullScreenView.isHidden = true
//            fullScreenView.alpha = 0 // Make it fully transparent
//            
//            view.subviews.compactMap { $0 as? TodoListView }.forEach { $0.isHidden = false }
//        }
//        
